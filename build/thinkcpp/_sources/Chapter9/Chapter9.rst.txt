...
displays the instance variables in a human-readable form. For example:
...
solution that does not require iteration?
...
Notice that the first two parameters can be declared ``const``, but the
third cannot.
